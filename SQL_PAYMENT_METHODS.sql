...
-- 7. Função para inicializar métodos de pagamento para usuários existentes
...
-- 8. Executar a função para inicializar métodos de pagamento para usuários existentes
