...
CREATE INDEX idx_collaborator_schedules_collab ON public.collaborator_schedules(collaborator_id);
CREATE INDEX idx_collaborator_schedules_day ON public.collaborator_schedules(day_of_week);
