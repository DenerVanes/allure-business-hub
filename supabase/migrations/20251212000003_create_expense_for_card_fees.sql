...
COMMENT ON FUNCTION public.create_expense_for_card_fees() IS 'Cria despesa automática quando um pagamento tem taxa de maquininha';
COMMENT ON FUNCTION public.update_expense_on_payment_delete() IS 'Atualiza ou remove despesa quando um pagamento com taxa é deletado';
