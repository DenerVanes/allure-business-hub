...
export const ManageExpenseCategoriesModal = ({ 
  ...
  useEffect(() => {
    if (user?.id && open) {
      ...
      const storedExcluded = localStorage.getItem(`excluded-expense-categories-${user.id}`);
      if (storedExcluded) {
        ...
        <DialogContent className="sm:max-w-[600px] max-h-[80vh] flex flex-col" style={{ borderRadius: '20px' }}>
          <DialogHeader>
            ...
            <DialogDescription className="text-[#5A4A5E]">
              Organize suas categorias de despesa. Adicione novas categorias personalizadas.
            </DialogDescription>
          </DialogHeader>
